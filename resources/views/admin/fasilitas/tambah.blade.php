...
<div class="container">
    ...
    <div class="row">
        <div class="col text-center">
            <span class="merriweather-bold" style="font-size: 30pt">Tambah Fasilitas</span>
        </div>
    </div>
    <form action="/admin/dotambahfasilitas" method="post" enctype="multipart/form-data">
        @csrf
    <div class="row justify-content-center merriweather-regular">
        <div class="col-6">
            ...
            <div class="mb-3">
                Deskripsi:
                <textarea name="deskripsi" id="" width="200px" class="form-control" height="150px">{{old('deskripsi')}}</textarea>
            </div>
            <div class="mb-3">
                Harga:
            ...
            <div class="row justify-content-center">
                <div class="col-auto">
                    <button class="btn btn-success" type="submit">Tambah Fasilitas</button>
                </div>
            </div>
        </div>
        </form>
